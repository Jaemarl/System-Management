...
else if(username == staffUsername3 && password == staffPassword3)
{
    ...
    // Teacher Login
        ...
        teacher_menu1:
            ...
            // ito po yung gagayahin simula dito
        ...
        teacher_menu2:
            ...
            // refer to line 1568
            // wag kalimutan i change yung variable name 
            cout << "2. Logout\n";
            cout << "Enter your choice: ";
            int teacherChoice = 0; // gagawing teacherChoice1 = 0 ;
            cin >> teacherChoice;// refer to line 2178 
// basta kapag bagong teacher na babaguhin din yung variable.
//tuloy tuloy po iyan hanggang teacher menu 5 check lang po lagi yung variable.
