...
login:
    ...
    teacher_menu:
        ...
        { // Handling 50 students for BSIT
            ...
            cin >> newPassword;
            int hasCOR, hasReportCard, hasMedical, hasGoodMoral, hasForm137;
            cout << "Does the student have a Certificate of Registration (COR)? (1. yes / 2. no): ";
            cin >> hasCOR;
            cout << "Does the student have a Report Card for Grade 11 and 12? (1. yes / 2. no): ";
            cin >> hasReportCard;
            cout << "Does the student have a Medical Certificate? (1. yes / 2. no): ";
            cin >> hasMedical;
            cout << "Does the student have a Good Moral Certificate? (1. yes / 2. no): ";
            cin >> hasGoodMoral;
            cout << "Does the student have a Form 137? (1. yes / 2. no): ";
            cin >> hasForm137;
            if (hasCOR == 2 || hasReportCard == 2 || hasMedical == 2 || hasGoodMoral == 2 || hasForm137 == 2)
            {
                cout << "Student cannot be registered without all required documents.\n";
                goto teacher_menu;
            }
